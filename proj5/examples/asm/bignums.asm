...
541c0788  LDLO(L7,1928)
5f901400  MOVE(O4,L5)
481c0000  CALL(L7)
5c178000  MOVE(L5,O0)
54140a84  LDLO(L5,2692)
5f902000  MOVE(O4,L8)
5f942400  MOVE(O5,L9)
5f980c00  MOVE(O6,L3)
48140000  CALL(L5)
...
18171408  ASR(L5,I5,L2)
0c180c14  DIV(L6,L3,L5)
200c1808  OR(L3,L6,L2)
54140808  LDLO(L5,2056)
5f931000  MOVE(O4,I4)
5f971400  MOVE(O5,I5)
5f981000  MOVE(O6,L4)
5f9f1c00  MOVE(O7,I7)
...
00041008  ADD(L1,L4,L2)
70131808  BGET(L4,I6,L2)
70171c08  BGET(L5,I7,L2)
181b1408  ASR(L6,I5,L2)
0c1c0c18  DIV(L7,L3,L6)
200c1c08  OR(L3,L7,L2)
54180964  LDLO(L6,2404)
5f931000  MOVE(O4,I4)
5f971400  MOVE(O5,I5)
5f981000  MOVE(O6,L4)
5f9c1400  MOVE(O7,L5)
...
00040c00  ADD(L1,L3,L0)
54000a84  LDLO(L0,2692)
5f931000  MOVE(O4,I4)
5f971400  MOVE(O5,I5)
5f980400  MOVE(O6,L1)
48000000  CALL(L0)
5c038000  MOVE(L0,O0)
540408c4  LDLO(L1,2244)
5f931000  MOVE(O4,I4)
5f971400  MOVE(O5,I5)
5f980800  MOVE(O6,L2)
5f9c0000  MOVE(O7,L0)
